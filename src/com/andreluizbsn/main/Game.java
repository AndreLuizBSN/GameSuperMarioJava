...
public class Game extends Canvas implements Runnable,KeyListener,MouseListener,MouseMotionListener{
	...
	public static int basex = 16, basey = 16;
	...
	public void keyPressed(KeyEvent e) {
		...
		if ( e.getKeyCode() == KeyEvent.VK_Z && Game.state.equals("NORMAL") ) {
			player.isGetLadder = true;
		}
		
		if ( e.getKeyCode() == KeyEvent.VK_UP && Game.state.equals("NORMAL") ) {
			player.up = true;
			System.out.println("up");
		}
		
		if ( e.getKeyCode() == KeyEvent.VK_DOWN && Game.state.equals("NORMAL") ) {
			player.down = true;
		}
